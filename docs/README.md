...
When you run the TRACE phases, the agents write their outputs here:
...
These subdirectories are **gitignored** — they contain organization-specific (and in healthcare, potentially sensitive) content. The consolidated view of phases T–A is the [Process Evidence Pack](../templates/process-evidence-pack.md).
