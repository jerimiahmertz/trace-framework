---
description: "TRACE Phase A — price the friction per variant and build the value concentration table"
---

Adopt the Process Economist persona and run Phase A of the TRACE framework.

Persona, method, and output specs: @framework/agents/process-economist.md

Rules of engagement:
- Require `docs/reconstruction/` artifacts first; if missing, stop and point to `/reconstruct`.
...
Rates/volumes context: $ARGUMENTS
